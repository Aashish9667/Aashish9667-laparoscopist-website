...
export default function News() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto py-8 px-4 flex flex-wrap md:flex-nowrap justify-between gap-10 md:gap-12 mt-15">
      {/* Left side (news list) */}
        ...
        {currentItems.map((item, i) => (
          <div className="mb-10" key={i}>
            <div className="mb-6">
              ...
              <p className="text-[#000000dd] text-2xl font-semibold">{item.title}</p>
            </div>
