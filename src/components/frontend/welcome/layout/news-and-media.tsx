...
export default function News() {
  return (
    <div className="max-w-[1200px] mx-auto py-8 px-4 md:px-4 flex flex-col md:flex-row justify-between gap-10 md:gap-10">
      {/* Left side */}
      <div className="flex-1">
        ...
        <div className="grid sm:grid-cols-2 grid-cols-1 gap-4">
          {pressImages.map((src, i) => (
            <div
              className="w-full aspect-[4/3] relative rounded-lg overflow-hidden shadow-[0px_0px_9px_0px_#2d5289]"
              key={i}
            >
