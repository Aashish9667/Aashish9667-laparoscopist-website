...
export default function LaparoscopySurgeons() {
  return (
    <div className="bg-gray-300 md:p-15 p-5">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between">
          ...
          <div className="md:w-1/2 flex flex-col gap-6 justify-center md:justify-end md:items-end pt-5 md:pt-0">
            {/* Doctor 1 */}
            <div className="relative md:w-[490px] md:h-[170px] w-80 h-50 bg-white rounded-3xl shadow-md overflow-visible flex flex-col items-center md:block mt-12 md:mt-0">
              ...
              >
                <h1 className="font-semibold text-[20px] text-[#00000099] md:pb-2 mt-8 md:mt-0">
                  Dr. Medhavi Tomar
                </h1>
            ...
            <div className="relative md:w-[490px] md:h-[170px] w-80 h-50 bg-white rounded-3xl shadow-md overflow-visible flex flex-col items-center md:block mt-12 md:mt-0">
              ...
              >
                ...
                <p className="hidden md:block text-[16px] text-[#00000099] pb-2 font-normal leading-tight">
