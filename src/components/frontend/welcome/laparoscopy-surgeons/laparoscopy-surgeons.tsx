        ...
        <div className="flex flex-col lg:flex-row items-start justify-between">
          ...
          <div className="lg:w-1/2 flex flex-col gap-6 justify-center lg:justify-end lg:items-end pt-5 lg:pt-0 ">
            ...
            <div className="relative xl:w-[490px] xl:h-[170px] lg:w-[390px] lg:h-[170px] md:w-max-[710px] md:h-max-[225px]  sm:w-max-[608px] sm:h-max-[225px] w-min-75 h-min-55 bg-white rounded-3xl shadow-lg overflow-visible flex flex-col items-center lg:block mt-12 lg:mt-0">
              ...
              <Image
                alt="Dr. Medhavi"
                className="hidden lg:block rounded-full h-30 w-30 absolute -left-12 top-1/2 transform -translate-y-1/2 border-2 border-[#24426d] z-10"
                height={96}
                src="/Medhavi-Tomar.png.avif"
                width={96}
              />
              ...
              >
                ...
                <a
                  className="flex items-center justify-center lg:justify-start gap-1 lg:pt-2 pt-4 text-[#24426d]"
            ...
            {/* Doctor 2 */}
            <div className="relative lg:w-[390px] lg:h-[190px] xl:w-[490px] xl:h-[190px]  sm:w-[608px] sm:h-[235px] w-75 h-70 bg-white rounded-3xl shadow-lg overflow-visible flex flex-col items-center lg:block mt-12 lg:mt-0">
              {/* Image Overlapping Top (mobile) */}
              <div className="absolute lg:hidden -top-10 flex justify-center w-full z-10">
                <Image
                  alt="Dr. Monika"
              ...
              <div
                className={`${poppins.className} px-6 py-6 lg:pl-23 pl-5 h-full flex flex-col justify-center text-center lg:text-left`}
              >
