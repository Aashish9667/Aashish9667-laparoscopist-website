      ...
      <div className="bg-gray-300 flex flex-col md:flex-row items-start justify-between  p-20 gap-8">
        ...
        <div className="text-left md:w-2/3">
          ...
          <p className="text-[16px] text-[#00000099] mb-3">
            ...
            25 years. She currently leads as the Chief Consultant at Star Hospital & Laparoscopic
            Surgical Centre, where she specializes in advanced laparoscopic surgeries, high-risk
            pregnancies, and comprehensive women’s health management.
          </p>
          <p className="text-[16px] text-[#00000099] mb-3">
            With an MBBS and MD (Obs. & Gynae) from the prestigious LLRM Medical College, Meerut,
            Dr. Tomar began her journey in medicine with academic distinction, securing honors in
            Pharmacology and Pathology and being awarded the Dr. K.L. Chopra Scholarship during her
            postgraduate studies. Her pursuit of excellence led her to receive specialized training
            in Gynaecological Laparoscopy from KEIL, Germany, adding global expertise to her
            clinical approach.
          </p>
          <p className="text-[16px] text-[#00000099]">
            Dr. Tomar’s commitment to advancing minimally invasive surgical techniques has made her
            a pioneer in Laparoscopic Infertility Surgery, Laparoscopic Hysterectomy, and
            Myomectomy. She also excels in managing ectopic pregnancies, colposcopy procedures, and
            hysteroscopic surgeries, offering patients faster recovery times with greater precision
            and safety.
          </p>
          ...
          <p className="text-[16px] text-[#00000099] mt-2">
            Dr. Tomar has served across multiple reputed institutions, including KM Hospital
            Khatauli, Anand Hospital, and various charitable setups. She has been a cornerstone of
            women’s health at Star Hospital since its inception, where she continues to blend
