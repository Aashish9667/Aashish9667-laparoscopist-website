    ...
    <div className="break-words overflow-hidden ">
      ...
      <div className="bg-white p-6  py-15  mx-auto max-w-[1200px]">
        ...
        >
          <ul className="list-disc pl-10 md:space-y-2  text-[#00000099]">
            ...
            <p className="text-[16px] md:leading-relaxed pl-4">
              Patients with large kidney stones that cannot be treated effectively with other
              methods.
            </p>
          </ul>
        </motion.div>
        ...
        <div className="mx-auto max-w-[1200px] p-6  py-15">
          ...
          >
            <p className="text-[16px] leading-tight md:md:leading-relaxed mb-2 md:mb-6 text-[#00000099]">
              Ureteroscopy is a minimally invasive procedure used to diagnose and treat stones in
      ...
      <div className="bg-white p-6  py-15 mx-auto max-w-[1200px]">
        ...
        >
          <p className="text-[16px] md:leading-relaxed mb-2 md:mb-6 text-[#00000099]">
            TURBT is a procedure to treat bladder tumors by removing them through a minimally
            invasive technique.
          </p>
        </motion.div>
        <motion.div
      ...
      <div className="bg-[rgb(234,237,243)]">
        <div className="mx-auto max-w-[1200px]  p-6  py-15">
          ...
          >
            <p className="text-[16px] md:leading-relaxed mb-6 text-[#00000099]">
              RIRS is a highly advanced, minimally invasive procedure for treating kidney
              conditions.
            </p>
          </motion.div>
          <motion.div
          ...
          >
            <ul className="list-disc pl-10 md:space-y-2  text-[#00000099]">
              <li className="text-[16px] font-semibold">Procedure Details:</li>
              <li className="text-[16px] ml-6 md:leading-tight">
                The instrument enters through natural body openings, traveling through the bladder
                and ureter to access the kidney.
              </li>
              <li className="text-[16px] ml-6 md:leading-tight">
