      ...
      <div className="space-y-10 mt-22">
        ...
        <div className="bg-gray-300 md:p-20 p-8">
          ...
          <p className="text-[#00000099] text-[16px] mb-4 md:mb-4">
            ...
            treatment for ODS. It involves resection of the rectum using a stapling device,
            resulting in significant symptom improvement and enhanced quality of life for patients
          </p>
        </div>
        {/* section4 */}
        <div className="bg-white md:pt-20 md:px-20 pt-8 px-8 md:pb-0">
          ...
          <h1 className="text-[25px] font-semibold mb-2 md:mb-20 md:mt-6">Surgical Treatment:</h1>
          <ul className="list-disc pl-6 text-[16px] space-y-2 text-[#00000099]  md:ml-4 md:leading-tight">
            <li>Fistulectomy:</li>
