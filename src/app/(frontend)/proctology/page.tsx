        ...
        <div className="bg-white md:px-6 md:py-10 p-6 mx-auto max-w-[1200px]">
          ...
          >
            <p className="text-[#00000099] text-[16px] mb-6 ">
              Hemorrhoids, or swollen veins in the rectal area, can cause discomfort and disrupt
              daily life. Treatment focuses on symptom relief and preventing complications.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            <ul className="list-disc pl-12 text-[16px] space-y-2 text-[#00000099]">
              ...
              <p>
                Soaking the affected area in warm water multiple times a day alleviates discomfort
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
          >
            <h1 className="text-[25px] font-semibold mb-6 mt-6   ">
          ...
          >
            <ul className="list-disc  text-[16px] space-y-2 text-[#00000099]  pl-12 ">
              ...
              <p>
                This procedure involves placing a rubber band around the base of the hemorrhoid to
                cut off blood supply, causing it to shrink and fall off.
              </p>
              <li className="font-semibold">Sclerotherapy:</li>
              <p>
                A chemical solution is injected into the hemorrhoid to shrink it, providing relief
                for less severe cases.
              </p>
              <li className="font-semibold">Infrared Coagulation (IRC):</li>
              <p>
                A minimally invasive procedure that uses infrared light to create scar tissue,
                cutting off blood supply to the hemorrhoid and causing it to shrink.
              </p>
              <li className="font-semibold">
                Stapled Hemorrhoidopexy (MIPH – Minimally Invasive Procedure for Hemorrhoids):
              </li>
              <p>
                A surgical technique where a circular stapling device is used to reposition
                prolapsed hemorrhoidal tissue and cut off its blood supply. It is less painful than
                conventional surgery and promotes quicker recovery.
              </p>
            </ul>
          </motion.div>
          <motion.div
          ...
          <div className=" md:p-6 p-6 py-15 mx-auto max-w-[1200px]">
            ...
            >
              <p className="text-[#00000099] text-[16px] mb-4 md:pb-10">
                ...
                stapling device, resulting in significant symptom improvement and enhanced quality
        ...
        <div className="bg-white md:px-6 md:pt-10 md:pb-6 pt-8 px-6 mx-auto max-w-[1200px]">
          ...
          >
            <ul className="list-disc pl-12 text-[16px] space-y-2 text-[#00000099]">
              ...
              <p>
                This advanced technique is a less invasive alternative to traditional surgery. Using
                a specialized endoscope, the fistula is treated internally without leaving a wound,
