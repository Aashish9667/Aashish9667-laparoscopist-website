    ...
    <div className="space-y-10 mt-22">
      ...
      <div className="bg-white md:p-20 p-8">
        ...
        <ul className="list-disc pl-6 text-[16px] space-y-2 text-[#00000099]">
          ...
          <p>
            Over-the-counter creams, ointments, or suppositories effectively relieve itching, pain,
            and swelling.
          </p>
        ...
        <ul className="list-disc pl-6 text-[16px] space-y-2 text-[#00000099]  md:ml-4 md:leading-tight">
          ...
          <li>Stapled Hemorrhoidopexy (MIPH – Minimally Invasive Procedure for Hemorrhoids):</li>
          <p>
      ...
      <div className="bg-gray-300 md:p-20 p-8">
        ...
        <p className="text-[#00000099] text-[16px] mb-4 md:mb-4">
          Obstructive Defecation Syndrome (ODS) is a condition characterized by difficulty in stool
          passage due to rectal dysfunction. Commonly affecting older women, ODS is diagnosed
          through a defecogram, which provides imaging of the rectum during defecation.
        </p>
        <p className="text-[#00000099] text-[16px] mb-4 md:mb-4">
          The Stapled Trans-Anal Resection of Rectum (STARR) procedure is an effective surgical
          treatment for ODS. It involves resection of the rectum using a stapling device, resulting
          in significant symptom improvement and enhanced quality of life for patients
        </p>
      </div>
      {/* section4 */}
